    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="#"><i class="fa fa-star"></i><span>My Reviews</span></a></li>
         <li><a href="{{ url('writer/myproposals ') }}"><i class="fa fa-link"></i> <span>My Proposals</span></a></li>
        <li><a href="{{ url('writer/activeorders ') }}"><i class="fa fa-link"></i> <span>Active orders</span></a></li>
