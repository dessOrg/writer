        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('admin/rates/store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('unittime') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                               <label class="radio-inline"> <input id="unittime" type="radio" class="" name="unittime" value="Hours">Hours</label>
                               <label class="radio-inline"><input id="unittime" type="radio" class="" name="unittime" value="Days">Days</label>
                               <label class="radio-inline"><input id="unittime" type="radio" class="" name="unittime" value="Weeks">Weeks</label>
                               <label class="radio-inline"><input id="unittime" type="radio" class="" name="unittime" value="Months">Days</label>
                       ...
                       <div class="form-group{{ $errors->has('timeline') ? ' has-error' : '' }}">
                        ...
                        <div class="form-group{{ $errors->has('hs') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="hs" type="text" class="form-control" name="hs" value="{{ old('hs') }}" placeholder="Rates in $(USD)" required autofocus>
                         ...
                         <div class="form-group{{ $errors->has('ug') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="ug" type="text" class="form-control" name="ug" value="{{ old('ug') }}" placeholder="Rates in $(USD)" required autofocus>
                       ...
                       <div class="form-group{{ $errors->has('gm') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="gm" type="text" class="form-control" name="gm" value="{{ old('gm') }}" placeholder="Rates in $(USD)" required>
                        ...
                        <div class="form-group{{ $errors->has('gd') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="gd" type="text" class="form-control" name="gd" value="{{ old('gd') }}" placeholder="Rates in $(USD)">
